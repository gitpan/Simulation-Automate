# This Makefile is for the Simulation::Automate extension to perl.
#
...
#     ABSTRACT => q[Simulation Automation Tool]
#     AUTHOR => q[Wim Vanderbauwhede <wim@motherearth.org>]
#     INSTALLSITEBIN => q[/usr/local/bin]
#     INST_BIN => q[./bin]
#     NAME => q[Simulation::Automate]
#     VERSION_FROM => q[Automate.pm]
...
DISTNAME = Simulation-Automate
NAME_SYM = Simulation_Automate
VERSION = 0.9.6
VERSION_SYM = 0_9_6
XS_VERSION = 0.9.6
...
FULLEXT = Simulation/Automate
BASEEXT = Automate
PARENT_NAME = Simulation
DLBASE = $(BASEEXT)
VERSION_FROM = Automate.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES = 
MAN1PODS = 
MAN3PODS = Automate.pm \
	Automate/Analysis.pm \
	Automate/Dictionary.pm \
	Automate/Main.pm \
	Automate/PostProcLib.pm \
	Automate/PostProcessors.pm
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Simulation
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Simulation
...
PM_TO_BLIB = Automate/PostProcLib.pm \
	blib/lib/Simulation/Automate/PostProcLib.pm \
	Automate/PostProcessors.pm \
	blib/lib/Simulation/Automate/PostProcessors.pm \
	Automate/Main.pm \
	blib/lib/Simulation/Automate/Main.pm \
	Automate.pm \
	blib/lib/Simulation/Automate.pm \
	Automate/Remote.pm \
	blib/lib/Simulation/Automate/Remote.pm \
	Automate/Analysis.pm \
	blib/lib/Simulation/Automate/Analysis.pm \
	Automate/Dictionary.pm \
...
manifypods : pure_all Automate/PostProcLib.pm \
	Automate/PostProcessors.pm \
	Automate/Main.pm \
	Automate.pm \
	Automate/Analysis.pm \
	...
	@$(POD2MAN) \
	Automate/PostProcLib.pm \
	$(INST_MAN3DIR)/Simulation::Automate::PostProcLib.$(MAN3EXT) \
	Automate/PostProcessors.pm \
	$(INST_MAN3DIR)/Simulation::Automate::PostProcessors.$(MAN3EXT) \
	Automate/Main.pm \
	$(INST_MAN3DIR)/Simulation::Automate::Main.$(MAN3EXT) \
	Automate.pm \
	$(INST_MAN3DIR)/Simulation::Automate.$(MAN3EXT) \
	Automate/Analysis.pm \
	$(INST_MAN3DIR)/Simulation::Automate::Analysis.$(MAN3EXT) \
	Automate/Dictionary.pm \
	$(INST_MAN3DIR)/Simulation::Automate::Dictionary.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Simulation/Automate/PostProcLib.pm
	rm -f blib/lib/Simulation/Automate/PostProcessors.pm
	rm -f blib/lib/Simulation/Automate/Main.pm blib/lib/Simulation/Automate.pm
	rm -f blib/lib/Simulation/Automate/Remote.pm blib/lib/Simulation/Automate/Analysis.pm
	rm -f blib/lib/Simulation/Automate/Dictionary.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,9,6,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>Simulation Automation Tool</ABSTRACT>\n\t<AUTHOR>Wim Vanderbauwhede &lt;wim\@motherearth.org&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{Automate/PostProcessors.pm blib/lib/Simulation/Automate/PostProcessors.pm Automate/PostProcLib.pm blib/lib/Simulation/Automate/PostProcLib.pm Automate/Main.pm blib/lib/Simulation/Automate/Main.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{Automate.pm blib/lib/Simulation/Automate.pm Automate/Remote.pm blib/lib/Simulation/Automate/Remote.pm Automate/Analysis.pm blib/lib/Simulation/Automate/Analysis.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{Automate/Dictionary.pm blib/lib/Simulation/Automate/Dictionary.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
